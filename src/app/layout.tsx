...
export const metadata: Metadata = {
  ...
  icons: {
    // Generated by scripts/generate-brand.mjs from one mark: the Western Ghats
    // range with a BNI-red point. SVG for modern browsers, ICO for legacy and
    // for link crawlers that only look for a favicon.
    icon: [
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'BNI Azpire, Pollachi — a room of professionals who send each other work.',
      },
    ],
  },
  twitter: {
